...
Changes from v3.9 (minor):
- TN_LABOR removed from automated scan; tn.gov blocks automated cloud access.
  Moved to manual monthly supplemental list (Section 2.4 of SOP). Total sources: 29.
"""
