...
- Total sources: 23 (16 active, 4 watch-list, 3 aggregate).
- AGC removed from aggregate sources.
...
ALL_SOURCES = JURISDICTIONS + WATCH_LIST + AGGREGATE_SOURCES  # 23 total (16 active + 4 watch-list + 3 aggregate)
