...
- Total sources: 21 (16 active, 4 watch-list, 4 aggregate, 0 Tennessee).
...
ALL_SOURCES = JURISDICTIONS + WATCH_LIST + AGGREGATE_SOURCES  # 24 total (16 active + 4 watch-list + 4 aggregate)
